...
class TestLoader:
    ...
    def discover(
        self, start_dir: str, pattern: str = "tests*.py", top_level_dir: str | None = None
...
def findTestCases(
    module: ModuleType, prefix: str = "tests", sortUsing: _SortComparisonMethod = ..., suiteClass: _SuiteClass = ...
) -> unittest.suite.TestSuite: ...
